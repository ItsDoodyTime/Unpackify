...
I decided to share it with others if it helps to solve their issues as well.

---
## 💎 Features
- Extracts all archives found in a folder
- Multithreaded and operates Simultaneously to perform fast and optimized
- Supports:
  - `.zip`
  - `.tar`
  - `.tar.gz`
...
## 🚨 Disclaimer & Notice 🚨
This software is provided AS IS, I do not accept any responsibility for any misuse of the software or any third-party alterations/adaptations.<br><br>
